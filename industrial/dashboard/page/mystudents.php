          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">My attached students</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
$sql = "SELECT * FROM students WHERE ind_s='$id' and complete='complete' or complete='upload'";
$query = mysqli_query($conn,$sql);
while($getr = mysqli_fetch_array($query)){
$ddt=$getr['complete'];
$sid=$getr['id'];
$ch=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM ind_assessment WHERE s_id=$sid"));
if($ch>0){
$s="#";
$l="Assessed";
}else{
