            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <th>Student Email</th>
                    <th>Practical orientation</th>
                    <th>Intellectual activity</th>
                    <th>Independence</th>
                  
                    <th>Communication</th>
                    <th>Innovation</th>
                   
                    <th>Tech Application</th>
                    <th>Total/30</th>
                     <th>Action</th>
                  </tr>
                  </thead>
                  <tbody>
                    ...
                    <?php
$sql = "SELECT * FROM ins_assessment where ssid=$id";
$query = mysqli_query($conn,$sql);
...
<a href="./delete_marked_logbook.php?log_id='.$id.'" class="btn btn-danger">Delete</a>
</div>
</td>
</tr>';
