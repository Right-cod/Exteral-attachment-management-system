            ...
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input readonly type="text" id="input-username" class="form-control" placeholder="Username" value="<?php echo$supervisor_fname; ?>" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Lastname</label>
                        <input readonly type="text" id="input-email" class="form-control" value="<?php echo$supervisor_lname; ?>" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input readonly type="text" id="input-last-name" class="form-control" placeholder="Last name" value="<?php echo$department; ?>" >
                      </div>
                    </div>
                       <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Email</label>
                        <input readonly value="<?php echo$email; ?>"  class="form-control"  type="text" >
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input readonly value="<?php echo$instituition_name; ?>"   class="form-control"  type="text" >
                      </div>
                    </div>
                        <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Company/Industry Address</label>
                        <input readonly value="<?php echo$instituition_address; ?>"  class="form-control"  type="text" >
                      </div>
                    </div>
              ...
              <div class="pl-lg-4">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                      <div class="form-group">
                <input value="Update Details" hidden   class="form-control btn-primary"  type="submit" name="update">
                      </div>
                    </div>
