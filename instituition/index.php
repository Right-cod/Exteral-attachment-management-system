...
<head>
	...
	<title>Institution Supervisor-Login</title>
	...
	<div class="auth-content">
		<div class="card">
			<div class="row align-items-center text-center">
				<div class="col-md-12">
					<div class="card-body">
						...
						<h4 class="mb-3 f-w-400">Institution Supervisor</h4>
						<input type="hidden" name="inns">
			...
			<input type="password" class="form-control"  name="password" 
						...
						<a href="#" class="btn btn-block btn-primary mb-4 signin" name="signin">Signin</a>
