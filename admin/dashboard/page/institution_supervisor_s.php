 ...
 <nav class="mt-2">
    ...
    <li class="nav-item menu-open">
         ...
         <i class="nav-icon fas fa-user"></i>
            ...
            <li class="nav-item">
            <a href="institution_supervisor.php" class="nav-link active">
         <i class="nav-icon fas fa-user"></i>
              <p>
 ...
 <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Register Institution Supervisor</h3>
           ...
           <div class="card-body">
            <form id="rds" onsubmit="return false">
          ...
          <div class="form-group mb-3">
              <label class="floating-label" for="Email">Instituition Name</label><br>
              <input type="text" class="form-control" name="instituition_name"  placeholder="" required>
            </div>
            <div class="form-group mb-3">
              <label class="floating-label" for="Email">Instituition Address</label><br>
              <input type="text" class="form-control" name="instituition_address"  placeholder="" required>
            </div>
            <div class="form-group mb-3">
...
$('#rds').on('submit',function(){
  $.ajax({
			url : "../../actions/institution_supervisors.php",
			method : "POST",
			data :$("#rds").serialize(),
