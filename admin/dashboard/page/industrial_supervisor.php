  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Industrial Supervisors</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Industrial Supervisors</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Industrial Supervisors</h3>
                <a href="./industrial_supervisor_s.php" class="btn btn-info btn-sm ml-auto my-auto btn-right">Add new industrial supervisor</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
